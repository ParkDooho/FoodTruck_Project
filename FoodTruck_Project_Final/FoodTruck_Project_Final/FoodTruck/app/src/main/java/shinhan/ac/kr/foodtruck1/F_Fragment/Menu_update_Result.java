...
public class Menu_update_Result extends AppCompatActivity {
    ImageView ImageBus;
    Animation anim;
    String shopMenu;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_update__result);
        ...
        val.put("action", "deleteData_text");
        val.put("shopID", ShopID);
        val.put("shopMenu", shopMenu);
        Menu_update_Result.NetworkTask networkTask = new Menu_update_Result.NetworkTask(url, val); //여기에 넣기
        networkTask.execute();
    }
    ...
    public class NetworkTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            finishImage.finish();
            Intent SaveFinish = new Intent(Menu_update_Result.this, ResultImage.class);
            SaveFinish.putExtra("shopId",ShopID);
            SaveFinish.putExtra("select_Temp",Select_Temp);
            Menu_update_Result.this.startActivity(SaveFinish);
            finish();
